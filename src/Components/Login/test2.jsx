...
const mockUser = {
    ...
    // useEffect(() => {
    //     // Temporary user data (hard-coded for testing)
    //     setUserData({
    //         username: "test4",
    //         password: "123"
    //     });
...
// Mock entries data
const mockEntries = [
    { id: 1, title: "Entry 1", description: "Description for Entry 1" },
    { id: 2, title: "Entry 2", description: "Description for Entry 2" },
    { id: 3, title: "Entry 3", description: "Description for Entry 3" },
];
    ...
    if (isLoggedIn) {
        ...
        return (
            <div className="dashboard">
                <h1>Welcome, {mockUser.username}!</h1>
                <input
                    type="text"
